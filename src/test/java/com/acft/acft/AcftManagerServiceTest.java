...
public class AcftManagerServiceTest {
    ...
    void psuedoIdMechanismRecyclesIds() throws Exception {
        ...
        acftManagerService.deleteTestGroupsOnSchedule();
        Assert.isTrue(acftManagerService.pseudoIdRepositoryContains(testGroup.getPseudoId()), "In psuedoIdMechanismRecyclesIds: service did not store ID of deleted testGroup in queue");
        Long testGroupQueueHead = acftManagerService.peekPseudoIdRepositoryTop();
        ...
        Assert.isTrue(acftManagerService.pseudoIdRepositoryContains(soldier.getPseudoId()), "In psuedoIdMechanismRecyclesIds: service did not store ID of deleted soldier in queue");
        Long soldierQueueHead = acftManagerService.peekPseudoIdRepositoryTop();
